# vtk-surface-bug
In the documentation of [vtkUnstructuredGridGeometryFilter](https://vtk.org/doc/nightly/html/classvtkUnstructuredGridGeometryFilter.html#details) it is stated that this filter provides the following functionality:
